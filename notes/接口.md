...
如何画时序图，自己的想法：主要是函数调用的关系，对外暴露的函数。

各个函数的使用关系。

![image-20211012084851461](/home/yy/.config/Typora/typora-user-images/image-20211012084851461.png)
